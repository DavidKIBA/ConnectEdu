...
const mockClasses = [
  { key: '0', title: '6e', description: 'Description de garderie', disabled: false },
  { key: '1', title: '5e', description: 'Description de P1', disabled: false },
