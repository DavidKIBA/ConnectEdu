...
const Calendrier = () => {
  ...
  const getListData = (value) => {
    ...
    const listData = classEventData.filter(
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout style={{ marginLeft: 135 }}>
        <Header
          style={{ background: "#001F3F", textAlign: "center", padding: 0 }}
        >
          <div
          ...
          {showImage && selectedSection && (
            <img
              src={
                ...
                `/images/${selectedSection.toLowerCase()}.jpg`
              }
          ...
          {showCalendars && (
            <Tabs onChange={handleTabChange} activeKey={selectedTab}>
              ...
              >
                ...
                <div>
                  Contenu du calendrier des devoirs pour {selectedClass}
                </div>
                <Modal
                  ...
                  >
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: "Veuillez saisir un événement!",
                        },
                      ]}
                    >
                      <TextArea rows={4} />
